    ...
    <div class="modal-dialog fin-mon-notification" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ol>
                    <li>Перевірте строк дії документа, що підтверджує особу, наявність відповідної фотокартки при
                        досягненні 25-и, 45-и річного віку
                    </li>
                    <li>Зробіть копію паспорту громадянина України (1, 2, 3-6 стр. та сторінку з останньою реєстрацією),
                        або іншого документа, що підтверджує особу
                    </li>
